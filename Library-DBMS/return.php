...
<body>
    ...
    <div class="container">
        <div class="col-sm-12 page-header" align="left">
          <h2 class="demo-headline" style="color:#FF1493">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Search &nbsp;Record</h2>
        </div>
    </div>
    <div class="container">
      ...
      <?php
          if (isset($_GET["submit"]))
          {
            ...
            $sql1="SELECT * from card WHERE cid=$cid;";
            ...
            if(!mysqli_num_rows($arr1)){
              echo "<script>alert('ID Error! Please check.');window.location='return.php'</script>";
            }
