...
<body>
    ...
    <div class="container">
        <div class="col-sm-12 page-header" align="left">
          <h2 class="demo-headline" style="color:#FFD700">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Borrow &nbsp;Book</h2>
        </div>
    </div>
        <!-- accessing database -->
    <div class="container">
          ...
          if (isset($_GET['submit']))
          {
            ...
            if ($arr)
            {
              ...
              if ($val[8]>0)
              {
                ...
                echo $sql2;
                $arr2=mysqli_query($con2,$sql2);
                $sql3="UPDATE book SET stock=stock-1 WHERE bid LIKE '%$bid%';";
                echo $sql3;
                $arr3=mysqli_query($con2,$sql3);
      ...
      ?>
        <!-- page body -->
          <form class="form-horizontal" action="borrow.php" method="get">
            ...
            <div class="form-group" >
              <label class="col-sm-2 lead" align='right'>Name</label>
              <div class="col-sm-5" align='left'>
                 <?php
